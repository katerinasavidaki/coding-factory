...
public class Main {
    ...
    public static void main(String[] args) {
        Teacher teacher = new Teacher(1, "Katerina", "Savidaki");
        User user = new User(1, "Costas", "Mask", "cmask", "12345", true);
        User user2 = new User(2, "Alice", "W.", "alicew", "1234567", true);
        Customer customer = new Customer(1, "Andrew", "Dimitriou", "076543289",
                "6937687654", "West Attica", "Attica", "Athens", "Patission", "76", "10434");
