...
//        System.out.println(doReplace(s));
    ...
    /**
     * matches (checks) if the input string is "red"
     *
    ...
    /**
     * matches (checks) if the input string is "red" or "green"
     *
     * @param s the input string
     * @return true if it is, false otherwise
     */
    ...
    /**
     * Matches (checks) if the input string is "red" or "Red" or "green" or "Green"
     * @param s the input string
     * @return true if it is, false otherwise
     */
